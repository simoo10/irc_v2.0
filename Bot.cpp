...
{
    std::map<std::string,int>::iterator it = ch.allclient.find(client.getNickname());
    if(it == ch.allclient.end())
    {
        std::string res = "You're not a member of our IRC Server,Please Authentifate \r\n";
